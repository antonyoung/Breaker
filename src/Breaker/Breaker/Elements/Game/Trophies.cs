...
namespace Breaker.Wp7.Xna4.Elements.Game
{
    ...
    class Trophies
    {
        ...
        public bool Validate(TrophieData td)
        {
            bool isAchieved = false;

            // 1 count trophies (x5) 
            if (td.Type == TrophieData.TrophieType.BrokeIt | td.Type == TrophieData.TrophieType.FirstLevel |
                td.Type == TrophieData.TrophieType.Hopeless | td.Type == TrophieData.TrophieType.Tunneled |
                td.Type == TrophieData.TrophieType.Vector | td.Type == TrophieData.TrophieType.Careful |
                td.Type == TrophieData.TrophieType.AllLevels | td.Type == TrophieData.TrophieType.Platinum)
            {
                if (td.Count == 0)
                {
                    td.Count++;
                    isAchieved = true;
                    //td.DateTimeAchievement = DateTime.Now;
                    td.IsAchieved = true;
                }
            }

            // 1.000 count trophies (x4)
            if (td.Type == TrophieData.TrophieType.SinglePlayer | td.Type == TrophieData.TrophieType.DoublePlayer |
                td.Type == TrophieData.TrophieType.ExtraBall | td.Type == TrophieData.TrophieType.TunneledCount)
            {
                td.Count++;
                //if (td.DateTimeAchievement == null && td.Count > 999)
                if (!td.IsAchieved && td.Count > 999)
            ...
            if (td.Type == TrophieData.TrophieType.Bonus | td.Type == TrophieData.TrophieType.LowScore |
                td.Type == TrophieData.TrophieType.Points20 | td.Type == TrophieData.TrophieType.Points30 |
                td.Type == TrophieData.TrophieType.Points40)
            {

                // Collected 10.000 times a Bonus breabable
                td.Count++;
                //if (td.DateTimeAchievement == null && td.Count > 9999)
                if (!td.IsAchieved && td.Count > 9999)
                {
                    isAchieved = true;
                    //td.DateTimeAchievement = DateTime.Now;
                    td.IsAchieved = true;
            ...
            if (td.Type == TrophieData.TrophieType.HighScore)
            {
                td.Count++;
                //if (td.DateTimeAchievement == null && td.Count > 99999)
                    if (!td.IsAchieved && td.Count > 99999)
            ...
            if (td.Type == TrophieData.TrophieType.BreakablesCount)
            {
                td.Count++;
                //if (td.DateTimeAchievement == null && td.Count > 999999)
                if (!td.IsAchieved && td.Count > 999999)
            ...
            //if (_isDebug && td.Type != TrophieData.TrophieType.BreakablesCount)
            //{
            //    // debug information.
            //    System.Diagnostics.Debug.WriteLine(string.Empty);
            //    System.Diagnostics.Debug.WriteLine("TrophieType = {0}", td.Type);
        ...
        public bool Validate(TrophieData td, int points)
        {
            bool isAchieved = false;

            if (td.Type == TrophieData.TrophieType.PointsMillion)
            {
                td.Count += points;
                //if (td.DateTimeAchievement == null && td.Count > 999999)
                if (!td.IsAchieved && td.Count > 999999)
