    ...
    class LoadingScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                string loadingText 
                    = ResourceManager.Text(ResourceManager.ResourceKeyName.LoadLoading);
                ...
                // Draw the text.
                spriteBatch.Begin();
                spriteBatch.DrawString(font, loadingText, textPosition, color);
                spriteBatch.End();
            }
        }
